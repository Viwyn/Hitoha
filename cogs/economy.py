...
class Economy(commands.Cog):
    ...
    @commands.command(name="balance", aliases=["bal"], help="Shows the balance of the user")
    ...
    @commands.command(name="addbalance", aliases=["addbal"], help="Adds a user's balance", hidden=True)
    @commands.is_owner()
    ...
    @commands.command(name="setbalance", aliases=["setbal"], help="Setss a user's balance", hidden=True)
    @commands.is_owner()
